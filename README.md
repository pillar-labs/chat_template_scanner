...
- direct and aliased content-triggered hidden system instructions
...
The full methodology, data provenance, label definitions, hyperparameters,
calibration policy, evaluation protocol, artifact hash, and reproducibility
limitations are documented in [`model/MODEL_CARD.md`](model/MODEL_CARD.md).
...
The observed clean review rate is 0.611%, and the clean-to-malicious rate is
0.170%. Suspicious remains data-limited; malicious behavior is the principal
blocking target.
